...
TEST_CASE("Tres Commas", "[gv] [fast]") {
    ...
    unsigned char *db = BuildTripleDistanceKVectorDatabase(catalog, NULL, DegToRad(.5), DegToRad(20), 1000);
    StarIdentifiers outputStarIds = NonDimStarIdAlgorithm(DegToRad(0.01), 0).Go(db, *gpi.InputStars(), catalog, camera);
