...
LOST_CLI_OPTION("angular-tolerance"        , float      , angularTolerance       , .03 , atof(optarg) , kNoDefaultArgument)
...
LOST_CLI_OPTION("generate-x-resolution"        , int   , generateXRes           , 1000, atoi(optarg)   , kNoDefaultArgument)
LOST_CLI_OPTION("generate-y-resolution"        , int   , generateYRes           , 1000, atoi(optarg)   , kNoDefaultArgument)
