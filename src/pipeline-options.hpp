...
LOST_CLI_OPTION("generate-zero-mag-photons"   , float , generateZeroMagPhotons    , 20000 , atof(optarg)    , kNoDefaultArgument)
LOST_CLI_OPTION("generate-saturation-photons" , float , generateSaturationPhotons , 150   , atof(optarg)    , kNoDefaultArgument)
...
LOST_CLI_OPTION("generate-blur-ra"            , float , generateBlurRa            , 0     , atof(optarg)    , kNoDefaultArgument)
LOST_CLI_OPTION("generate-blur-de"            , float , generateBlurDe            , 0     , atof(optarg)    , kNoDefaultArgument)
LOST_CLI_OPTION("generate-blur-roll"          , float , generateBlurRoll          , 0     , atof(optarg)    , kNoDefaultArgument)
LOST_CLI_OPTION("generate-exposure"           , float , generateExposure          , 0.2   , atof(optarg)    , 0.1)
